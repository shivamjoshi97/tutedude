    ...
    <>
        <div class="row p-5 pb-0">
            <div class="col-lg-5 mb-5">
                <div class="box">
                    <div class="row py-5 pb-1 px-5 justify-content-between">
                        <div class="col-xl-4 col-6">
                            <span class="box-text">Referal Earning</span><br/>
                            <span class="box-tex">₹2500</span>
                        </div>
                        <div class="col-xl-4 col-6">
                            <span class="box-text">Total Referals</span><br/>
                            <span class="box-tex">7</span>
                        </div>
                        <div class="col-xl-4 col-6">
                            <span class="box-text">Wallet Balance</span><br/>
                            <span class="box-tex">₹500</span>
                        </div>
                        <div class="col-xl-12 col-6 py-4 px-5">
                            <div class="withdraw text-white text-center p-2 fs-6">Withdraw Balance</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-5 mb-5">
                <span class="fs-2 fw-bolder" style={{color: "#800080"}}>Your Referal Code</span>
                <div class="ref-box">
                    <div class="d-flex p-3 justify-content-center" style={{backgroundColor: "#fff", margin: "2px" , borderRadius: "10px"}}>
                        <span class="ref-text">EDCH54</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="row mb-4 p-5 pt-0 pb-0">
            <span class="working mb-4">How does it work?</span>
            <div class="col-lg-5">
                <div class="d-flex align-items-center mb-2">
                    <div class="icon-box d-flex align-content-center justify-content-center me-7">
                        <svg class="mt-7" width="32" height="16" viewBox="0 0 32 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="w-75">
                        <span class="fs-3 fw-bolder">Invite Your Friends</span><br/>
                        <span class="fs-4 text-muted">Share the link tutedude.com with Your friends</span>
                    </div>
                </div>
                <div class="d-flex align-items-center mb-2">
                    <div class="icon-box d-flex align-content-center justify-content-center me-7">
                        <svg class="mt-7" width="19" height="24" viewBox="0 0 19 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="w-75">
                        <span class="fs-3 fw-bolder">You get ₹200 as referral money</span><br/>
                        <span class="fs-4 text-muted">On totl purchase the friend makes, into your wallet</span>
                    </div>
                </div>
                <div class="d-flex align-items-center mb-2">
                    <div class="icon-box me-7 ps-3">
                        <svg class="mt-6 ms-2" width="26" height="24" viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="w-75">
                        <span class="fs-3 fw-bolder">Transfer money from wallet</span><br/>
                        <span class="fs-4 text-muted">When the wallet balance reaches ₹200 or more, you can withdraw it</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-5">
                <div class="d-flex align-items-center mb-2">
                    <div class="icon-box d-flex align-content-center justify-content-center me-7">
                        <svg class="mt-7" width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="w-75">
                        <span class="fs-3 fw-bolder">Friend purchases any course</span><br/>
                        <span class="fs-4 text-muted">Using your REFERRAL CODE in the payments page</span>
                    </div>
                </div>
                <div class="d-flex align-items-center mb-2">
                    <div class="icon-box d-flex align-content-center justify-content-center me-7">
                        <svg class="mt-6" width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="w-75">
                        <span class="fs-3 fw-bolder">Your Friend gets ₹200 Off</span><br/>
                        <span class="fs-4 text-muted">On his overall fee on sucessful purchase using your referal code</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="mb-5 ps-5">
            <h4 class="text-purple">Friends Who Enrolled</h4>
        </div>
        <Term></Term>
    </>
  )
